"""PAL (Projection-free Anchor Learning) — CLS-variant alignment layer.
...
Each modality gets its own instance with its own anchors (one alignment layer is
instantiated per modality), matching the original PAL design where anchors_img
and anchors_txt are separate parameter sets.
"""
