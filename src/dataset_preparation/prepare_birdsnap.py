...
def _parse_args(args):
    ...
    parser.add_argument(
        ...
        type=str,
        default="./data",
        help="Root dir to store everthything",
    )
...
def run(args=None):
    ...
    dataset_path = os.path.join(args.root_dir, "birdsnap")
    ...
    shutil.copytree(
        os.path.join(dataset_path, "download/images"),
    ...
    for subdir in os.listdir(os.path.join(dataset_path, "train")):
        ...
        for file in all_images:
            ...
            try:
                ...
                all_images_good.append(img)
            except Exception as e:
                print(f"Corrupted image {os.path.join(subdir, file)}: {e}")
