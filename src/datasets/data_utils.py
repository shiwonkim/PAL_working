...
def get_datasets(dataset, transform, root_dir: Union[str, Path] = "./data", **kwargs):
    ...
    elif dataset == "quilt1m":
        # Quilt-1M histopathology image-caption pairs (train pairs for PAL).
        # Layout: <data>/quilt1m/quilt_1M_lookup.csv + images extracted flat
        # under <data>/quilt1m/images/ (image_path column is a bare filename).
